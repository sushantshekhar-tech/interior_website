        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="main_menu_iner">
                    <div class="logo">
                        <a href="index"><img src="img/decore-logo.png" alt="#" ></a>
                    </div>
...
<!--::header part end-->
    ...
    <script>
        ...
        document.querySelector('.menu-trigger').addEventListener('click', function() {
            document.querySelector('.off-canven-menu').classList.toggle('active');
        });

        document.querySelector('.close-icon').addEventListener('click', function() {
            document.querySelector('.off-canven-menu').classList.remove('active');
        });
    </script>
